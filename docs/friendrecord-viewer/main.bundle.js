  ...
  n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
    ...
    async function gn() {
      ...
      try {
        ...
        if (ratingValue >= 17) {
            ratingHtml = `<span style="font-size:52px; font-weight:bold; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.7));"><span style="background: linear-gradient(to bottom, #fff970 0%, #ff7c7c 20%, #f42cde 40%, #2f45ff 60%, #00ccff 80%, #00ff80 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">${mainRating}</span><span style="font-size:36px; background: linear-gradient(to bottom, #fff970 0%, #ff7c7c 20%, #f42cde 40%, #2f45ff 60%, #00ccff 80%, #00ff80 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">${subRating}</span></span>`;
        }
