  ...
  n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
    ...
    async function gn() {
      ...
      try {
        ...
        const bestRecords = allRecords.filter(item => (item.newV === 0 || (item.newV === 2 && item.difficulty !== "ULT")) && item.score !== -1).sort((a,b) => b.rating - a.rating || b.score - a.score).slice(0, 30);
        const newRecords = allRecords.filter(item => (item.newV === 1 || (item.newV === 2 && item.difficulty === "ULT")) && item.score !== -1).sort((a,b) => b.rating - a.rating || b.score - a.score).slice(0, 20);
        ...
        container.innerHTML = `
          ...
          <div style="border-top:2px solid var(--theme-border); padding-top:20px; margin-top:30px; display:flex; justify-content:space-between; color:var(--theme-text-dim); font-size:16px;">
            <div>Generated by CHUNITHM Tools (@TSAIBEE)<br>All copyrights of music jacket image on this site belong copyright holders.</div>
