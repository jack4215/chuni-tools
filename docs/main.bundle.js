( () => {
    ...
    ( () => {
        ...
        ;
        function ge(t) {
            let s, i, a, c, l, u, h, d, p, f, s3, i3, a3, c3, l3, s4, i4, a4, c4, l4, s5, i5, a5, c5, l5, s6, i6, a6, c6, l6, s7, i7, a7, c7, l7, s8, i8, a8, c8, l8, s9, i9, a9, c9, l9, s10, i10, a10, c10, l10, s11, i11, a11, c11, l11, s12, i12, a12, c12, l12, g, T = t[0]("usages.tools1.title") + "", x = t[0]("usages.tools1.description") + "", _ = t[0]("usages.tools2.title") + "", M = t[0]("usages.tools2.description") + "", A = t[0]("usages.tools3.title") + "", B = t[0]("usages.tools3.description") + "", C = t[0]("usages.tools4.title") + "", D = t[0]("usages.tools4.description") + "", E = t[0]("usages.tools5.title") + "", F = t[0]("usages.tools5.description") + "", O = t[0]("usages.tools6.title") + "", P = t[0]("usages.tools6.description") + "", Q = t[0]("usages.tools7.title") + "", R = t[0]("usages.tools7.description") + "", S = t[0]("usages.tools8.title") + "", U = t[0]("usages.tools8.description") + "", V = t[0]("usages.tools9.title") + "", W = t[0]("usages.tools9.description") + "", X = t[0]("usages.tools10.title") + "", Y = t[0]("usages.tools10.description") + "", X1 = t[0]("usages.tools11.title") + "", Y1 = t[0]("usages.tools11.description") + "", X2 = t[0]("usages.tools12.title") + "", Y2 = t[0]("usages.tools12.description") + "";
            return {
                c() {
                    s = v("h3"),
                    i = y(T),
                ...
                p(e, [t]) {
                    ...
                    1 & t && X1 !== (X1 = e[0]("usages.tools11.title") + "") && H(i11, X1),
                    1 & t && Y1 !== (Y1 = e[0]("usages.tools11.description") + "") && (c11.innerHTML = Y1),
                    1 & t && X2 !== (X2 = e[0]("usages.tools12.title") + "") && H(i12, X2),
                    1 & t && Y2 !== (Y2 = e[0]("usages.tools12.description") + "") && (c12.innerHTML = Y2)
                },
                i: e,
                o: e,
                d(e) {
