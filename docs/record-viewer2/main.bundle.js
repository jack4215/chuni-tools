    ...
    async function gn() {
      ...
      overlay.innerHTML = `
        <div style="background:var(--theme-bg-main, #1e1e24);padding:20px 30px;border-radius:10px;text-align:center;box-shadow:0 4px 15px rgba(0,0,0,0.5);border:2px solid var(--theme-border, #3e3e4a);">
          <h3 style="color:var(--theme-text, #fff);margin-top:0;margin-bottom:10px;">請選擇下載格式<br><span style="font-size:0.8em;color:var(--theme-text-dim, #aaa);">Choose Download Format</span></h3>
          <div style="display:flex;gap:15px;justify-content:center;margin-top:20px;">
            <button id="btn-gn-new" style="padding:10px 20px;background:var(--theme-control, #4CAF50);color:#fff;border:none;border-radius:5px;cursor:pointer;font-size:16px;font-weight:bold;transition:0.2s;">精緻版 B50<br><span style="font-size:0.8em;font-weight:normal;">(New Style)</span></button>
            <button id="btn-gn-old" style="padding:10px 20px;background:var(--theme-bg-sub, #555);color:var(--theme-text-control, #fff);border:1px solid var(--theme-border, #777);border-radius:5px;cursor:pointer;font-size:16px;font-weight:bold;transition:0.2s;">標準版 B40<br><span style="font-size:0.8em;font-weight:normal;">(Standard)</span></button>
          </div>
          <button id="btn-gn-cancel" style="margin-top:20px;padding:8px 20px;background:transparent;color:var(--theme-text-dim, #aaa);border:1px solid var(--theme-text-dim, #aaa);border-radius:5px;cursor:pointer;transition:0.2s;">取消 / Cancel</button>
        </div>
      `;
