      ...
      overlay.innerHTML = `
        <div style="background:var(--theme-bg-main, #1e1e24);padding:20px 30px;border-radius:10px;text-align:center;box-shadow:0 4px 15px rgba(0,0,0,0.5);border:2px solid var(--theme-border, #3e3e4a);">
          ...
          <div style="display:flex;gap:15px;justify-content:center;margin-top:20px;">
            ...
            <button id="btn-gn-old" style="padding:10px 20px;background:var(--theme-bg-sub, #555);color:var(--theme-text-control, #fff);border:1px solid var(--theme-border, #777);border-radius:5px;cursor:pointer;font-size:16px;font-weight:bold;transition:0.2s;">${d(wt)("share.format.old")}</button>
          </div>
          <button id="btn-gn-cancel" style="margin-top:20px;padding:8px 20px;background:transparent;color:var(--theme-text-dim, #aaa);border:1px solid var(--theme-text-dim, #aaa);border-radius:5px;cursor:pointer;transition:0.2s;">${d(wt)("share.format.cancel")}</button>
        </div>
      `;
