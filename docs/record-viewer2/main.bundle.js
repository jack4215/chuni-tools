  ...
  n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
    ...
    async function gn() {
      ...
      try {
        ...
        // 3. 動態抓取並複製個人資訊面板 (Profile Header)
        let profileHtml = '';
        // 尋找包含 .stats-name 的外層 .wrapper 容器
        ...
        if (profileNode) {
          ...
          clone.style.minWidth = '550px';
          profileHtml = clone.outerHTML;
        } else {
          // 備用方案 (若抓不到網頁面板時)
          const stats = d(Ut);
          profileHtml = `<div style="font-size:32px; font-weight:bold; background:var(--theme-control); color:var(--theme-text-control); padding:10px 25px; border-radius:10px;">${stats?.name || 'Player'}</div>`;
        }
        ...
        container.innerHTML = `
          <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:3px solid var(--theme-border); padding-bottom:20px; margin-bottom:30px; color:var(--theme-text);">
            <div>
              <h1 style="margin:0; font-size:48px; letter-spacing:2px;">Best & New 50</h1>
              <div style="margin-top:10px; font-size:20px; color:var(--theme-text-dim);">Generated by CHUNITHM Record Viewer</div>
            </div>
          ...
          <div style="display:flex; gap:40px;">
            <div style="flex: 1;">
              <h3 style="font-size:28px; color:var(--theme-text); border-left:6px solid var(--theme-control); padding-left:12px; margin-bottom:20px;">Best 30</h3>
            ...
            <div style="flex: 1;">
              <h3 style="font-size:28px; color:var(--theme-text); border-left:6px solid var(--theme-control); padding-left:12px; margin-bottom:20px;">New 20</h3>
              <div style="display:grid; grid-template-columns:repeat(5, 1fr); gap:18px;">
