(() => {
  ...
  n.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
    ...
    ! function(e) {
      ...
      e["LMN"] = "17", e["LMN+"] = "18", e["VRS"] = "19", e["X-VR"] = "20", e["XVX"] = "21"
    }(_s || (_s = {}));
    ...
    const et = Ue("filterGenre", Ke), eet = Ue("filterRelease", Kee), eeet = Ue("filterRank", Keee),
      tt = Ne("usedConstData", "crossverse", ["crossverse", "cross2verse"], (() => {
      ...
      rt = function(e, t, n = (() => {})) {
        ...
        return { subscribe: s, set(t) { a(t), localStorage.setItem(e, JSON.stringify(t)), n(t) }, update: i, reset() { this.set(t) }, toggle() { this.update((e => !e)) } }
      }("showPlaycount", !1),
      rtt = function(e, t, n = (() => {})) {
        let r = localStorage.getItem(e);
        (null === r || "true" !== r && "false" !== r) && (r = JSON.stringify(t), localStorage.setItem(e, r));
      ...
      at = [Ae, De, Ze, Ye, Qe, et, eet, eeet, tt, nt, rt, rtt],
      it = {
    ...
    async function gnNew() {
      ...
      try {
        ...
        await Promise.all([...imgs].map(async (img) => {
          try {
            const fetchUrl = img.src + (img.src.includes('?') ? '&' : '?') + 'cors_bypass=' + Date.now();
    ...
    async function gnConst(minC, maxC) {
      ...
      try {
            ...
            constKeys.forEach(cStr => {
              ...
              <div style="flex: none; width: 100%; display:flex; flex-direction:column; background:#2b2b33; border:2px solid #3e3e4a; border-radius:0; padding:25px; box-sizing:border-box; box-shadow:0 8px 25px rgba(0,0,0,0.3); margin-bottom:25px;">
                <div style="flex: none; display:flex; justify-content:flex-start; align-items:baseline; border-bottom:3px solid var(--theme-border); padding-bottom:10px; margin-bottom:20px; height: 50px; box-sizing: border-box; gap:25px;">
                  ...
                  <div style="display:flex; gap: 20px; font-size: 32px; color: var(--theme-text-dim); font-weight: bold; letter-spacing:0.5px;">
        ...
        if (rawBlob) {
            loading.innerHTML = "<div style='background:rgba(0,0,0,0.85);padding:25px;border-radius:0;box-shadow:0 4px 15px rgba(0,0,0,0.5);'>" + (d(wt)("share.loading.compressing") || "Compressing Image...") + "</div>";
            const img = new Image();
            img.src = URL.createObjectURL(rawBlob);
    ...
    async function gn() {
      ...
      overlay.innerHTML = `
        <div id="gn-modal-box" style="width:70%;max-width:32rem;background:var(--theme-bg-main, #1e1e24);padding:20px 30px;border-radius:10px;text-align:center;box-shadow:0 4px 15px rgba(0,0,0,0.5);">
          ...
          <div style="display:flex;flex-direction:column;gap:15px;justify-content:center;margin-top:20px;">
            ...
            <button id="btn-gn-const"style="padding:10px 20px;background:var(--theme-control);color:#fff;border:none;border-radius:5px;cursor:pointer;font-size:16px;font-weight:bold;transition:0.2s;">${d(wt)("share.format.const")}</button> 
            <div id="const_slider_mount"></div>
          </div>

          <div style="color:var(--theme-text-dim);margin:10px 0;">${d(wt)("share.format.pcnotice")}</div>
          <h3 style="color:var(--theme-text, #fff);margin-top:30px;margin-bottom:10px;">${d(wt)("share.chunilib.title")}</h3>
      ...
      const closeModal = (action) => {
        let minC = 14.0, maxC = 15.4;
        if (action === "const" && sliderComp) {
          try {
            const vals = sliderComp.$$.ctx[0]; 
            const vals2 = sliderComp.$$.ctx[1];
            minC = Math.min(vals, vals2) || 14.0;
        ...
        setTimeout(() => {
          if (sliderComp) { try { sliderComp.$destroy(); } catch(e){} }
          overlay.remove();
          
          if (action === "new") gnNew();
          else if (action === "old") gnOld();
          else if (action === "const") gnConst(minC, maxC);
        }, 100);
      };
    ...
    function vn(t) {
      let n, r, o, a, i, l, c, d, u, f, p, h, g, m = function(e) {
        let t, n, r, o, s, a = "crossverse" === e[1] ? "🌐" : "🗾";
        return {
          c() {
          ...
          p(e, o) {
            2 & o && a !== (a = "crossverse" === e[1] ? "🌐" : "🗾") && I(n, a), 3 & o && r !== (r = e[0]("header.title.constData", {
              name: e[0]("settings.data.constData." + e[1])
            })) && O(t, "title", r)
          },
          d(e) {
    ...
    function kn(e) {
      j(e, "svelte-y51pcd", "label.svelte-y51pcd{display:flex;-ms-flex-direction:column;flex-direction:column;padding:0.5rem;gap:0.5rem}select.svelte-y51pcd{width:100%;height:3rem;padding-left:1rem;padding-right:2.5rem;font-size:1em;font-weight:bold;background:var(--theme-bg-honor);border:var(--theme-border) 2px solid;border-radius:1rem;color:inherit;cursor:pointer;appearance:none;background-image:linear-gradient(45deg, transparent 50%, currentColor 0), linear-gradient(135deg, currentColor 50%, transparent 0);background-position:calc(100% - 20px) calc(1px + 50%), calc(100% - 16.02px) calc(1px + 50%);background-size:4px 4px, 4px 4px;background-repeat:no-repeat}.select.svelte-y51pcd option{background-color: var(--theme-bg-honor);}")
    }
    ...
    function Yn(t) {
      ...
      return {
        ...
        p(e, s) {
          ...
          (8192 & s) && z(r, "display", e[13] ? "" : "none"),
          (16384 & s) && z(r2, "display", e[14] ? "" : "none"),
    ...
    function Qn(e, t, n) {
      ...
      u(e, At, (e => n(11, i = e))),
      u(e, xt, (e => n(12, l = e))),
      u(e, rt, (e => n(13, showPC = e))),
      u(e, rtt, (e => n(14, showRK = e)));
    ...
    function kr(e) {
      let t, n, r, o, a, i, l, c, d, u, f, p, h, g, m, v, b, bb, bbb, y, yy, yyy, w, $, x, j, S, T, C, N, U, A, L, I, L_rk, I_rk, R, F, B, V, q, W, J, X, G, Y, Z, K, ee, te, ne, se, ae, ie, le, ce, de, ue, fe, _rk, ve = e[0]("settings.main.title") + "",
      ...
      let Le_rk = { label: e[0]("settings.data.worldrank") };
      function De_rk(t) { e[26](t) }
      void 0 !== e[25] && (Le_rk.checked = e[25]), L_rk = new Nn({ props: Le_rk }), Q.push((() => we(L_rk, "checked", De_rk)));

      let Pe = (e[5] || e[25]) && br(e);

      function Oe(t) { e[14](t) }
      let _e = { label: e[0]("settings.data.showScoreDiff") };
      function Ie(t) { e[15](t) }
      void 0 !== e[6] && (_e.checked = e[6]), F = new Nn({ props: _e }), Q.push((() => we(F, "checked", Oe))), q = new lr({});
      ...
      return void 0 !== e[8] && (Fe.value = e[8]), te = new Tn({ props: Fe }), Q.push((() => we(te, "value", ze))), {
        c() {
          t = H("div"), n = H("div"), r = D(), o = H("div"), a = H("button"), a.textContent = "✕", i = D(), l = H("h3"), c = D(), d = H("h4"), u = D(), $e(f.$$.fragment), g = D(), $e(m.$$.fragment), v = D(), $e(b.$$.fragment), y = D(), $e(bb.$$.fragment), yy = D(), $e(bbb.$$.fragment), yyy = D(), w = H("hr"), $ = D(), x = H("h4"), j = D(), He && He.c(), S = D(), $e(T.$$.fragment), N = D(), U = H("div"), A = D(), $e(L.$$.fragment), I = D(), $e(L_rk.$$.fragment), I_rk = D(), Pe && Pe.c(), R = D(), $e(F.$$.fragment), V = D(), $e(q.$$.fragment), W = D(), J = H("hr"), X = D(), G = H("h4"), Y = D(), $e(Z.$$.fragment), ee = D(), $e(te.$$.fragment), se = D(), ae = H("hr"), ie = D(), le = H("button"), O(n, "class", "modal-bg svelte-iga5r4"), O(a, "type", "button"), O(a, "class", "close-btn svelte-iga5r4"), z(l, "margin", "0"), O(d, "class", "svelte-iga5r4"), O(w, "class", "svelte-iga5r4"), O(x, "class", "svelte-iga5r4"), z(U, "color", "var(--theme-text-dim)"), z(U, "margin", ".5em auto"), O(J, "class", "svelte-iga5r4"), O(G, "class", "svelte-iga5r4"), O(ae, "class", "svelte-iga5r4"), O(le, "type", "button"), O(le, "class", "reset-btn svelte-iga5r4"), O(o, "class", "modal svelte-iga5r4"), O(t, "class", "wrapper svelte-iga5r4")
        },
        m(s, p) {
          M(s, t, p), k(t, n), k(t, r), k(t, o), k(o, a), k(o, i), k(o, l), l.innerHTML = ve, k(o, c), k(o, d), d.innerHTML = ye, k(o, u), xe(f, o, null), k(o, g), xe(m, o, null), k(o, v), xe(b, o, null), k(o, y), xe(bb, o, null), k(o, yy), xe(bbb, o, null), k(o, yyy), k(o, w), k(o, $), k(o, x), x.innerHTML = je, k(o, j), He && He.m(o, null), k(o, S), xe(T, o, null), k(o, N), k(o, U), U.innerHTML = Se, k(o, A), xe(L, o, null), k(o, I), xe(L_rk, o, null), k(o, I_rk), Pe && Pe.m(o, null), k(o, R), xe(F, o, null), k(o, V), xe(q, o, null), k(o, W), k(o, J), k(o, X), k(o, G), G.innerHTML = Te, k(o, Y), xe(Z, o, null), k(o, ee), xe(te, o, null), k(o, se), k(o, ae), k(o, ie), k(o, le), le.innerHTML = Ce, de = !0, ue || (fe = [P(n, "click", xt.toggle), P(a, "click", xt.toggle), P(le, "click", e[17])], ue = !0)
        },
        p(e, [t]) {
          ...
          const s = {};
          1 & t && (s.label = e[0]("settings.data.playcount")), !_ && 32 & t && (_ = !0, s.checked = e[5], oe((() => _ = !1))), L.$set(s);
          
          const s_rk = {};
          1 & t && (s_rk.label = e[0]("settings.data.worldrank")), !_rk && 33554432 & t && (_rk = !0, s_rk.checked = e[25], oe((() => _rk = !1))), L_rk.$set(s_rk);

          (e[5] || e[25]) ? Pe ? (Pe.p(e, t), 33554464 & t && ge(Pe, 1)) : (Pe = br(e), Pe.c(), ge(Pe, 1), Pe.m(o, R)) : Pe && (pe(), me(Pe, 1, 1, (() => { Pe = null })), he());
        ...
        i(e) {
          de || (ge(f.$$.fragment, e), ge(m.$$.fragment, e), ge(b.$$.fragment, e), ge(bb.$$.fragment, e), ge(bbb.$$.fragment, e), ge(He), ge(T.$$.fragment, e), ge(L.$$.fragment, e), ge(L_rk.$$.fragment, e), ge(Pe), ge(F.$$.fragment, e), ge(q.$$.fragment, e), ge(Z.$$.fragment, e), ge(te.$$.fragment, e), re((() => { de && (ce || (ce = be(t, $n, { duration: 100 }, !0)), ce.run(1)) })), de = !0)
        },
        o(e) {
          me(f.$$.fragment, e), me(m.$$.fragment, e), me(b.$$.fragment, e), me(bb.$$.fragment, e), me(bbb.$$.fragment, e), me(He), me(T.$$.fragment, e), me(L.$$.fragment, e), me(L_rk.$$.fragment, e), me(Pe), me(F.$$.fragment, e), me(q.$$.fragment, e), me(Z.$$.fragment, e), me(te.$$.fragment, e), ce || (ce = be(t, $n, { duration: 100 }, !1)), ce.run(0), de = !1
        },
        d(e) {
          e && E(t), ke(f), ke(m), ke(b), ke(bb), ke(bbb), He && He.d(), ke(T), ke(L), ke(L_rk), Pe && Pe.d(), ke(F), ke(q), ke(Z), ke(te), e && ce && ce.end(), ue = !1, s(fe), unsubQe && unsubQe()
        }
      }
    }
    ...
    function Lr(e) {
      ...
      return ~($ = P(e)) && (x = L[$] = U[$](e)), {
        c() {
          t = H("div"),this.t = t, n = H("h2"), r = A(S), o = D(), s = H("div"), a = H("h2"), i = A(T), l = D(), c = H("span"), d = A("OP "), u = A(C), f = D(), p = H("div"), h = H("span"), g = A(N), v = D(), b = H("div"), $e(y.$$.fragment), w = D(), x && x.c(), O(n, "class", "stats-name svelte-1rv2o5c"), O(a, "class", "svelte-1rv2o5c"), O(c, "class", "svelte-1rv2o5c"), O(s, "class", "stats-rating svelte-1rv2o5c"), O(p, "class", "stats-honor svelte-1rv2o5c"), O(p, "data-honor", m = e[3].honor[0].color), B(p, "marquee", !0), O(b, "class", "stats-items svelte-1rv2o5c"), O(t, "class", "wrapper svelte-1rv2o5c"), O(t, "style", `background: ${getBackgroundColor(e[3].ratingPn)}`)
        ...
        p(e, [t]) {
          (!j || 8 & t) && S !== (S = e[3].name + "") && I(r, S), (!j || 8 & t) && T !== (T = e[3].rating + "") && I(i, T), (!j || 8 & t) && C !== (C = e[3].overPower + "") && I(u, C), (!j || 8 & t) && N !== (N = e[3].honor[0].text + "") && I(g, N), (!j || 8 & t && m !== (m = e[3].honor[0].color)) && O(p, "data-honor", m);
          const n = {};
    ...
    function Jr_PC(e) {
      ...
      let cr = selCount(e), cb = cr(e);
      return {
        c() { cb.c(); ph1 = L(); },
        m(t, a) { cb.m(t, a); M(t, ph1, a); },
        p(e, f) {
          let ncr = selCount(e);
          if (cr === ncr) cb.p?.(e, f); else { cb.d(1); cr = ncr; cb = cr(e); cb.c(); cb.m(ph1.parentNode, ph1); }
        },
        d(detach) { cb.d(detach); if (detach) E(ph1); }
      }
    }
    function Jr_RK(e) {
      let ph2;
      const selRank  = e => void 0 === e[0].worldRank ? Grw : Wrr;
      let rr = selRank(e), rb = rr(e);
      return {
        c() { rb.c(); ph2 = L(); },
        m(t, a) { rb.m(t, a); M(t, ph2, a); },
        p(e, f) {
          let nrr = selRank(e);
          if (rr === nrr) rb.p?.(e, f); else { rb.d(1); rr = nrr; rb = rr(e); rb.c(); rb.m(ph2.parentNode, ph2); }
        },
        d(detach) { rb.d(detach); if (detach) E(ph2); }
      }
    }
    function Wrr(e) {
      let td, textNode, val = (e[0].worldRank ?? "-") + "";
      return {
        c() { td = H("td"); textNode = A(val); O(td, "class", "svelte-1gjhsjp"); },
        m(target, anchor) { M(target, td, anchor); k(td, textNode); },
        p(e, s) { let newVal = (e[0].worldRank ?? "-") + ""; if (val !== newVal) { val = newVal; I(textNode, val); } },
        d(detach) { if (detach) E(td); }
      };
    }
    function Grw(e) {
      let td, cleanup, bound = false;
      return {
        c() { td = H("td"); td.innerHTML = '<span class="svelte-1gjhsjp">  </span>'; O(td, "class", "pc-hidden svelte-1gjhsjp"); B(td, "disabled", e[5]); },
        m(target, anchor) { M(target, td, anchor); if (!bound) { cleanup = P(td, "click", e[9]); bound = true; } },
        p(e, flags) { 32 & flags && B(td, "disabled", e[5]); },
        d(detach) { if (detach) E(td); bound = false; cleanup && cleanup(); }
      };
    }
    function Xr(e) {
      let t, n, r = (e[0].playCount ?? "?") + "";
      return {
        c() { t = H("td"), n = A(r), O(t, "class", "svelte-1gjhsjp") },
        m(e, r) { M(e, t, r), k(t, n) },
        p(e, t) { 1 & t && r !== (r = (e[0].playCount ?? "?") + "") && I(n, r) },
        d(e) { e && E(t) }
      }
    }
    function Gr(e) {
      let t, n, r;
      return {
        c() { t = H("td"), t.innerHTML = '<span class="svelte-1gjhsjp">  </span>', O(t, "class", "pc-hidden svelte-1gjhsjp"), B(t, "disabled", e[5]) },
        m(o, s) { M(o, t, s), n || (r = P(t, "click", e[8]), n = !0) },
        p(e, n) { 32 & n && B(t, "disabled", e[5]) },
        d(e) { e && E(t), n = !1, r() }
      }
    }
    function Vz(data) {
      return {
        c() { this.el = document.createElement("span"); this.el.className = "newV-indicator"; this.el.textContent = data; },
        m(target, anchor) { target.insertBefore(this.el, anchor); },
        d(detach) { if (detach) this.el.remove(); },
      };
    }
    ...
    function Yr(t) {
      ...
      let L = U(t), _ = L(t);
      function R(e, t) { return e[3] ? qr : Vr }
      let z = R(t), F = z(t), V = Wr(t);
      let q_pc = t[4] && "all" === t[2] && Jr_PC(t);
      let q_rk = t[10] && "all" === t[2] && Jr_RK(t);
      ...
      return {
        ...
        p(e, [t]) {
          ...
          if (shouldShowNewV) {
              if (newVIndicator) { newVIndicator.d(1); newVIndicator = null; }
              newVIndicator = Vz(T); newVIndicator.c(); f.textContent = ""; newVIndicator.m(u, null);
          } else {
              if (newVIndicator) { newVIndicator.d(1); newVIndicator = null; }
              f.textContent = T;
          }
        ...
        i: e, o: e,
        d(e) {
          e && E(n), N && N.d(), _.d(), F.d(), V && V.d(), q_pc && q_pc.d(), q_rk && q_rk.d(), $ = !1, x();
    ...
    function Zr(e, t, n) {
      ...
      u(e, nt, (e => n(1, r = e))), u(e, $t, (e => n(2, o = e))), u(e, Tt, (e => n(3, s = e))), u(e, rt, (e => n(4, a = e))), u(e, jt, (e => n(5, i = e))), u(e, rtt, (e => n(10, a_rk = e)));
      let { song: l_song } = t;
      return e.$$set = e => {
        "song" in e && n(0, l_song = e.song)
      }, [l_song, r, o, s, a, i, function() {
        "all" === o && Tt.toggle()
      }, function() {
        ...
        i || gt("songPlayCount", l_song.difficulty, l_song.idx).then((e => { n(0, l_song.playCount = e, l_song) })).catch((() => { n(0, l_song.playCount = null, l_song) }))
      }, () => {
        i || gt("songWorldRank", l_song.difficulty, l_song.idx).then((e => { n(0, l_song.worldRank = e, l_song) })).catch((() => { n(0, l_song.worldRank = null, l_song) }))
      }, a_rk]
    }
    ...
    function ao(e, t, n) {
      ...
      return e.$$set = e => {
        ...
        70 & e.$$.dirty && n(4, r = d.sort(h ? (e, t) => -Je[p](e, t) : Je[p])), 18304 & e.$$.dirty && n(3, o = [{
          ...
          display: "overpowerPercent", sort: "opp", condition: "percentage" == l || "dgpercentage" == l || "eudgpercentage" == l
        }, {
          display: "overpower", sort: "op", condition: "value" == l || "dgvalue" == l || "eudgvalue" == l
        }, {
          display: "rank", sort: "score", condition: "hide" == l, nocur: !i
        }, {
          display: "clr", sort: "clr", condition: "clr" == l
        }, {
          display: i ? "scoreDiff" : "score", sort: i ? "scoreDiff" : "score"
        }, {
          display: "rating", sort: "rating"
        }, {
          display: "ajfc", sort: "aj",
        }, {
          display: "playcount", sort: "playcount", condition: a && "all" === s
        }, {
          display: "worldrank", sort: "worldrank", condition: a_rk && "all" === s
        }])
    ...
    function Eo(e) {
      j( e, "svelte-1cp0kbr", `.wrapper.svelte-1cp0kbr{border:var(--theme-border) 3px solid;border-radius:0.5rem;background-color:var(--theme-bg-sub);box-sizing:border-box;width:100%;max-width:600px;padding:0.5rem;margin:0.5rem;display:flex;justify-content:space-evenly;text-align:center;gap:0.8em;overflow-x:scroll}.wrapper.svelte-1cp0kbr::-webkit-scrollbar{display:none} .item.svelte-1cp0kbr{display:flex;flex-direction:column} .item.svelte-1cp0kbr div:nth-child(1){color:var(--theme-label)} .item.svelte-1cp0kbr div:nth-child(2){font-size:1.2em;font-weight:bold} .item.fc.svelte-1cp0kbr div:nth-child(1){color:var(--theme-clear-fc)} .item.aj.svelte-1cp0kbr div:nth-child(1){color:var(--theme-clear-aj)} .item.mx.svelte-1cp0kbr:not(.zero) div.svelte-1cp0kbr:nth-child(2){color:var(--theme-clear-ajc);text-shadow:0 0 10px var(--theme-clear-ajc)}.item.full.svelte-1cp0kbr div.svelte-1cp0kbr:nth-child(2){color:var(--theme-clear-aj);text-shadow:0 0 10px var(--theme-clear-aj)} .item.zero.svelte-1cp0kbr div:nth-child(2){color:var(--theme-text-dim);text-shadow:none} .total.svelte-1cp0kbr{color:var(--theme-text-dim);font-size:0.8rem;display:flex;align-items:end}` );
    }
    ...
    function Yo(e, t, n) {
      ...
      return u(e, Ht, (e => n(13, z = e))), u(e, Ye, (e => n(14, i = e))), u(e, Ze, (e => n(15, l = e))), u(e, At, (e => n(16, h = e))), u(e, et, (e => n(17, c = e))), u(e, eet, (e => n(21, j = e))), u(e, eeet, (e => n(22, jk = e))), u(e, Qe, (e => n(18, d = e))), u(e, nt, (e => n(2, f = e))), u(e, De, (e => n(19, g = e))), u(e, Tt, (e => n(20, m = e))), u(e, $t, (e => n(5, v = e))), u(e, Ae, (e => n(6, b = e))), u(e, wt, (e => n(7, y = e))), u(e, At, (e => n(8, w = e.filter((item) => (item.newV === 0 || (item.newV === 2 && item.difficulty !== "ULT")) && item.score !== -1).map((item, index) => ({ ...item, order: index + 1 }))))), u(e, At, (e => n(9, $ = e.filter(item => (item.newV === 1 || (item.newV === 2 && item.difficulty === "ULT")) && item.score !== -1).map((item, index) => ({ ...item, order: index + 1 }))))), u(e, jt, (e => n(10, x = e))), u(e, xt, (e => n(11, k = e))), p($t, v = window.location.hash.slice(1), v), 
      e.$$.update = () => {
        6800388 & e.$$.dirty && n(0, r = h.filter((e => ("hide" != f || e.score >= 0) && ("clr" != f || e.score >= 0) && (!(f === "dgvalue" || f === "dgpercentage") || (e.dg === 1 || e.dg === 2)) && (!(f === "eudgvalue" || f === "eudgpercentage") || ((e.dg === 1 || e.dg === 2) && e.score >= 0)) && d[e.difficulty] && c[Ie.find((t => _e[t] == e.genre))] && j[Rl.find((t => _s[t] == e.release))] && jk[Rk.find(t => { const val = _k[t]; return Array.isArray(val) ? val.includes(e.rank) : val === e.rank; })] && l >= e.const && e.const >= i))), sFS = r, 1 & e.$$.dirty && n(4, o = (() => {
          let e = {};
