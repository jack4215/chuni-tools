(() => {
    ...
    var r, a;
    (a = r || (r = {})).basic = "BAS", a.advanced = "ADV", a.expert = "EXP", a.master = "MAS", a.ultima = "ULT";
    const c = Object.values(r);
    var i;
    async function s(e = r.master) {
      const t = new FormData;
      t.append("genre", "99"), t.append("token", n("_t"));
      const a = {
          [r.ultima]: "sendUltima",
          [r.master]: "sendMaster",
          [r.expert]: "sendExpert",
        ...
        c = await async function(e, t) {
          ...
          if (503 === n.status || 405 === n.status) throw new Error("Service temporarily unavailable");
          if (-1 != n.url.indexOf("/error")) throw new Error("Request failed: rejected by server");
      ...
      return Array.from(c.querySelectorAll(".box01.w420")[1].querySelectorAll("form")).map((t => {
        ...
        return {
          ...
          score: o ? (r = o, Number([...r].filter((e => "," !== e)).join(""))) : -1,
          difficulty: e,
    ...
    function d(e) {
      let t = 0;
      return l.some(((n, o) => (t = o, e >= n[0]))), l[t][1]
    }
    const u = [{
      score: 1009e3,
      base: 21500,
    ...
    function m(e) {
      ...
      if (!n("_t")) return alert(a.pleaseLogin), void(window.location.href = o);
      try {
        const e = function() {
          const e = r.createElement("button");
          e.className = "chuni-tool-btn";
          const n = r.createElement("link");
          return n.rel = "stylesheet", n.href = t("export-csv") + "/common/styles/inject.css", e.innerText = a.downloadCSV, r.getElementsByTagName("head")[0].appendChild(n), n.addEventListener("load", (() => {
        ...
        e.addEventListener("click", (async () => {
          ...
          const o = function(e, t, n) {
              const o = e,
                ...
                a = [];
              if (o.map((e => {
                  if ("WE" === e.difficulty) return e.title = m(e.title), e.const = -1, e.rating = 0, e.op = -1, e.opMax = -1, e.opPercent = -1, void(e.rank = d(e.score));
                  void 0 === r[e.title] && (e.title = m(e.title));
                  let t = r[e.title];
                  void 0 === t ? (a.push(e), e.const = -1, e.rating = 0) : (e.const = t[e.difficulty], t.uncertain?.includes(e.difficulty) && (e.constUncertain = !0), e.rawRating = function(e) {
                    ...
                    return o = e.score >= 975e3 ? 10 * Math.floor(o / 10) : 100 * Math.floor(o / 100), 5 * (o + t)
                  }(e), e.opMax = f(e), e.opPercent = 100 * e.op / e.opMax, e.rank = d(e.score)
                })), n && a.length) {
                const e = {};
                a.forEach((t => {
                  var n;
              ...
              return o.sort(p), o.map(((e, t) => {
                e.order = t + 1
              })), o
            }(n, await fetch(t("export-csv") + "/data/song-const/luminous.json").then((async e => await e.json()))),
            i = o.map((e => `"${e.title.replace(/"/g,'""')}",${e.difficulty},${e.const},${e.score},${e.rating},${e.op}`));
          e.innerText = a.downloaded;
          const l = document.createElement("a");
          l.href = "data:text/plain;charset=utf-8," + encodeURIComponent("title,difficulty,const,score,rating,op\n" + i.join("\n")), l.target = "_blank", l.download = `chunithm_record_${(new Date).toISOString()}.csv`, l.style.display = "none", r.body.appendChild(l), l.click(), r.body.removeChild(l), setTimeout((() => {
            e.innerText = a.downloadCSV
          }), 3e3)
        }))
      } catch (e) {
        alert(a.needReload), console.log(e)
      }
    }(document)
  })();