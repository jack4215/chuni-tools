( () => {
    ...
    !function(o, r) {
        ...
        -1 != i.indexOf("/mobile/home/userOption/updateUserName") ? s("idxmap-generate") : i.startsWith("/mobile/record/musicGenre") ? (s("scorepercent"), setTimeout(() => {s("fetch-all");}, 5)) : i.startsWith("/mobile/record/musicWord") ? (s("scorepercent"), setTimeout(() => {s("fetch-all");}, 5)) : i.startsWith("/mobile/record/musicRank") ? (s("scorepercent"), setTimeout(() => {s("fetch-all");}, 5)) : i.startsWith("/mobile/record/musicLevel") ? (s("scorepercent"), setTimeout(() => {s("fetch-all");}, 5)) : -1 != i.indexOf("/mobile/loginBonus") ? s("export-csv") : -1 != i.indexOf("mobile/collection/customise")  ? (s("customiselist"), setTimeout(() => {s("fetch-all");}, 5)) : -1 != i.indexOf("mobile/collection/trophy")  ? (s("titlelist"), setTimeout(() => {s("fetch-all");}, 5)) : -1 != i.indexOf("/mobile/collection/characterList")  ? (s("charlistrank"), setTimeout(() => {s("fetch-all");}, 5)) : -1 != i.indexOf("/mobile/ranking/teamPoint") ? (s("team-ranking"), setTimeout(() => {s("team-csv");}, 200)) : -1 != i.indexOf("/mobile/friend/friendDetail") ? s("friendidx") : -1 != i.indexOf("/mobile/record/playlogDetail") ? (s("targetrank"), setTimeout(() => {s("fetch-all");}, 5)) : -1 != i.indexOf("/mobile/collection") || -1 != i.indexOf("/mobile/collection/characterDetail") ? (s("charrank"), setTimeout(() => {s("fetch-all");}, 5)) : -1 != i.indexOf("/mobile/friend/genreVs/battleStart") ? (s("export-friend-csv"), setTimeout(() => { s("fetch-friend"), setTimeout(() => { s("battlegnsort"); }, 10); }, 5)) : -1 != i.indexOf("/mobile/friend/levelVs/battleStart") ? (s("export-friend-csv"), setTimeout(() => { s("fetch-friend"), setTimeout(() => { s("battlelvsort"); }, 10); }, 5)) : -1 != i.indexOf("/mobile/friend")  ? (s("friendsort"), setTimeout(() => {s("fetch-all");}, 5)) : -1 != i.indexOf("/mobile/netStore/netpointLog")  ? (s("ptcount"), setTimeout(() => {s("fetch-all");}, 5)) : s("fetch-all")
    }(document, window)
}
)();
