    ...
    !function(o, r) {
        const a = {
            [n.en_US]: {
                ...
                containerHTML: `
                    <p><a href="https://chuni.tsaibee.org/constupdate" target="_blank">X-VERSE-X Chart Constant Update List</a></p>
                    <hr width="96%">
            ...
            [n.zh_TW]: {
                ...
                containerHTML: `
                    <p><a href="https://chuni.tsaibee.org/constupdate" target="_blank">X-VERSE-X 譜面定數更新列表</a></p>
                    <hr width="96%">
