(() => {
    ...
    r.o = (e, t) => Object.prototype.hasOwnProperty.call(e, t), (() => {
        ...
        const Er = class extends Se {
            constructor(e) {
                super(), je(this, e, Mr, Cr, i, {
                    checked: 0,
                    label: 1
                }, Tr)
            }
        ...
        const Ar = class extends Se {
            constructor(e) {
                super(), je(this, e, Ur, Hr, i, {
                    label: 2,
                    min: 3,
                    max: 4,
                    step: 5,
        ...
        function Ir(t) {
            let r, n, o, s, a, i, l, c, d = t[0]("settings.filter.diff") + "",
                u = Object.values(t[1]).every(_r),
                f = t[0]("settings.filter.diff.notify") + "",
                p = u && Or(t),
                h = De,
                g = [];
            for (let e = 0; e < h.length; e += 1) g[e] = Dr(Pr(t, h, e));
            return {
                c() {
                ...
                p(e, [t]) {
                    if (1 & t && d !== (d = e[0]("settings.filter.diff") + "") && o.p(d), 2 & t && (u = Object.values(e[1]).every(_r)), u ? p ? p.p(e, t) : (p = Or(e), p.c(), p.m(n, null)) : p && (p.d(1), p = null), 6 & t) {
                        let r;
                        for (h = De, r = 0; r < h.length; r += 1) {
                            const n = Pr(e, h, r);
                            g[r] ? g[r].p(n, t) : (g[r] = Dr(n), g[r].c(), g[r].m(i, null))
                        }
        ...
        const zr = class extends Se {
            constructor(e) {
                super(), je(this, e, Rr, Ir, i, {}, Lr)
            }
        };
        ...
        function qr(t) {
            let r, n, o, s, a, i, l, c, d, u = t[2]("settings.filter.genre") + "",
                ...
                p = _e,
                h = [];
            for (let e = 0; e < p.length; e += 1) h[e] = Vr(Br(t, p, e));
            return {
                c() {
                ...
                p(e, [t]) {
                    if (4 & t && u !== (u = e[2]("settings.filter.genre") + "") && (n.innerHTML = u), 3 & t) {
                        ...
                        for (p = _e, r = 0; r < p.length; r += 1) {
                            const n = Br(e, p, r);
                            h[r] ? h[r].p(n, t) : (h[r] = Vr(n), h[r].c(), h[r].m(s, a))
                        }
        ...
        const Jr = class extends Se {
            constructor(e) {
                super(), je(this, e, Wr, qr, i, {}, Fr)
            }
        };
        ...
        function Gr(t) {
            ...
            return {
                c() {
                    r = H("div"), n = H("button"), a = L(), i = H("input"), l = L(), c = H("span"), c.textContent = "～", d = L(), u = H("input"), D(n, "type", "button"), D(n, "class", "btn svelte-1lhvhf8"), n.disabled = o = t[2] || Yr(t[0], t[1]), D(i, "type", "number"), D(i, "min", "1"), D(i, "placeholder", "from"), D(i, "inputmode", "numeric"), D(i, "class", "svelte-1lhvhf8"), D(u, "type", "number"), D(u, "min", "1"), D(u, "placeholder", "to"), D(u, "inputmode", "numeric"), D(u, "class", "svelte-1lhvhf8"), D(r, "class", "wrapper svelte-1lhvhf8")
                },
                m(e, o) {
                ...
                p(e, [t]) {
                    8 & t && h !== (h = e[3]("playcount.fetch.button") + "") && (n.innerHTML = h), 7 & t && o !== (o = e[2] || Yr(e[0], e[1])) && (n.disabled = o), 1 & t && I(i.value) !== e[0] && R(i, e[0]), 2 & t && I(u.value) !== e[1] && R(u, e[1])
                },
                i: e,
                o: e,
                d(e) {
        ...
        function on(e) {
            ...
            void 0 !== e[1] && (c.value = e[1]), t = new Sr({
                props: c
            }), Q.push((() => we(t, "value", l)));
        ...
        function wn(e) {
            ...
            void 0 !== e[1] && (Ne.high = e[1]), void 0 !== e[2] && (Ne.low = e[2]), f = new Ar({
                props: Ne
            }), Q.push((() => we(f, "high", Me))), Q.push((() => we(f, "low", Ee))), m = new zr({}), b = new Jr({});
            let He = !1;
            ...
            void 0 !== e[4] && (Ae.value = e[4]), T = new Sr({
                props: Ae
            }), Q.push((() => we(T, "value", Ue)));
            let Pe = {
                label: e[0]("settings.data.playcount")
            };
            void 0 !== e[5] && (Pe.checked = e[5]), P = new Er({
                props: Pe
            ...
            void 0 !== e[6] && (Ie.checked = e[6]), F = new Er({
                props: Ie
            ...
            void 0 !== e[7] && (Re.value = e[7]), Z = new Sr({
                props: Re
            ...
            return void 0 !== e[8] && (Fe.value = e[8]), te = new Sr({
                props: Fe
                ...
                o(e) {
                    me(f.$$.fragment, e), me(m.$$.fragment, e), me(b.$$.fragment, e), me(He), me(T.$$.fragment, e), me(P.$$.fragment, e), me(Oe), me(F.$$.fragment, e), me(q.$$.fragment, e), me(Z.$$.fragment, e), me(te.$$.fragment, e), ce || (ce = be(t, wr, {
                        duration: 100
                    }, !1)), ce.run(0), de = !1
                },
                d(e) {
